  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative pt-40 sm:pt-48 pb-20 lg:pt-56 lg:pb-32 overflow-hidden bg-slate-900 border-b border-slate-800">
        ...
        <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-[500px] h-[500px] bg-primary/20 rounded-full blur-[140px] pointer-events-none" />
        <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-secondary/15 rounded-full blur-[120px] pointer-events-none" />

        <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-center z-10">
          <div className="inline-flex items-center gap-2 rounded-full border border-secondary/20 bg-secondary/10 px-4 py-1.5 text-sm font-semibold text-secondary mb-8 backdrop-blur-sm self-center">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-6xl mx-auto max-w-4xl mb-6 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary via-accent to-white">Digital Healthcare</span>
          </h1>
      ...
      <section className="py-24 sm:py-32 bg-white relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 -mr-20 -mt-20 w-[400px] h-[400px] bg-accent/20 rounded-full blur-[100px] opacity-60"></div>
        <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-[400px] h-[400px] bg-primary/5 rounded-full blur-[100px] opacity-60"></div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative order-2 lg:order-1 perspective-1000">
              ...
              <div className="absolute -inset-4 bg-gradient-to-tr from-accent to-primary/10 rounded-[40px] transform -rotate-3 border border-secondary/10 shadow-inner"></div>
            ...
            <div className="order-1 lg:order-2">
              <h2 className="text-base font-semibold leading-7 tracking-wide uppercase text-secondary">Our Story</h2>
              <p className="mt-2 text-3xl font-bold tracking-tight text-slate-900 sm:text-5xl lg:text-[3rem] leading-none mb-6">
                Connecting you to care that feels <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">like home.</span>
              </p>
              ...
              <div className="mt-12 flex gap-4 sm:gap-6">
                ...
                <div className="flex-1 bg-gradient-to-br from-primary/5 flex flex-col justify-center items-center to-white rounded-3xl p-6 sm:p-8 border border-primary/10 shadow-sm group transition-all duration-300 hover:shadow-md hover:border-primary/20 hover:-translate-y-1">
                  ...
                  <div className="mt-3 text-sm font-semibold text-slate-700 border-t border-primary/5 pt-3 text-center w-full">Satisfaction Rate</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 sm:py-32 bg-[#FAF8F5] relative border-t border-slate-100">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
          <div className="mx-auto max-w-2xl text-center mb-16 px-4">
            <h2 className="text-base font-semibold leading-7 tracking-wide uppercase text-secondary">Our Core Pillars</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10">
            {values.map((value, idx) => (
              <div key={idx} className="group relative bg-white rounded-[2rem] p-8 shadow-sm hover:shadow-xl shadow-slate-200/50 transition-all duration-500 hover:-translate-y-2 border border-slate-100/60 overflow-hidden flex flex-col">
                ...
                <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-secondary to-primary transform scale-x-0 origin-left transition-transform duration-500 group-hover:scale-x-100"></div>
                ...
                <div className="flex-1 flex flex-col relative z-20">
                  <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4 group-hover:text-primary transition-colors duration-300">
                    {value.title}
                  </h3>
                ...
                <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-gradient-to-br from-accent to-primary/10 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              </div>
            ))}
          </div>
        </div>
