...
export default function ContactPage() {
    ...
    return (
        <main className="min-h-screen bg-background flex flex-col font-sans">
            ...
            {/* Hero Section */}
            <section className="relative pt-40 sm:pt-48 pb-20 lg:pt-56 lg:pb-32 overflow-hidden bg-slate-900">
                ...
                <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-center z-10">
                    ...
                    <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-6xl mx-auto max-w-4xl mb-6 leading-tight">
                        Get in <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary via-accent to-white">Touch</span>
                    </h1>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                        ...
                        <div className="space-y-12">
                            <div>
                                <h2 className="text-3xl font-bold tracking-tight text-primary sm:text-4xl">Contact Information</h2>
                            ...
                            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-1">
                                ...
                                <Link 
                                    ...
                                    className="group flex items-center gap-6 p-6 rounded-3xl bg-accent/30 border border-secondary/15 shadow-sm hover:shadow-xl hover:shadow-secondary/20 hover:-translate-y-1 transition-all duration-300"
                                >
                                    <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-secondary text-white shadow-lg shadow-secondary/35 group-hover:scale-110 transition-transform">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-primary mb-1">WhatsApp Us</h3>
                                        <p className="text-secondary font-bold">+94 76 251 5494</p>
                                ...
                                <div className="flex items-center gap-6 p-6 rounded-3xl bg-white border border-slate-100 shadow-sm hover:shadow-md transition-all">
                                    <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-accent/40 text-secondary">
                            ...
                            {submitted ? (
                                <div className="text-center py-12">
                                    ...
                                    <button 
                                        ...
                                        className="rounded-full bg-primary px-8 py-3.5 text-base font-semibold text-white shadow-lg hover:bg-primary/95 transition-colors cursor-pointer"
                                    >
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <input 
                                                ...
                                                className="w-full rounded-2xl border-slate-200 bg-slate-50 px-4 py-3.5 text-slate-900 placeholder:text-slate-400 focus:border-secondary focus:bg-white focus:ring-2 focus:ring-secondary/20 transition-all outline-none" 
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea 
                                            ...
                                            onChange={handleChange}
                                            className="w-full rounded-2xl border-slate-200 bg-slate-50 px-4 py-3.5 text-slate-900 placeholder:text-slate-400 focus:border-secondary focus:bg-white focus:ring-2 focus:ring-secondary/20 transition-all outline-none resize-none" 
                                    ...
                                    <button 
                                        ...
                                        className="w-full rounded-2xl bg-secondary py-4 px-8 text-lg font-bold text-white shadow-xl shadow-secondary/15 hover:bg-secondary/90 hover:-translate-y-1 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0 flex items-center justify-center gap-3 cursor-pointer"
                                    >
                                        {isSubmitting ? (
                                            <>
